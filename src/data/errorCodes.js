...
const errorCodes = {
    "NOT_LOGGED_IN": ({redirect})=> <div className='text-center'>
        ...
        <div className='p-8'>
            <Link to={"/login"} state={{redirect}} className='py-2 px-4 rounded-xl border border-white/50' style={{ marginRight: 0 }}>LOGIN</Link>
        </div>
    </div>,
    "SUB_EXPIRED": ()=> <div className='text-center'>
        ...
        <div className='p-8'>
            <Link to={"/deep-analyzer"} className='py-2 px-4 rounded-xl border border-white/50' style={{ marginRight: 0 }}>SUBSCRIBE</Link>
        </div>
    </div>,
