...
const Home = () => {
    ...
    return (
        <>
            <SEO
                title="Global Sports Trade | AI-Powered Predictions & Analytics"
                description="Unlock daily high-confidence sports match predictions generated by advanced AI models."
