                            ...
                            <div className="w-full border-y border-white/10 bg-white/[0.03] px-5 py-5 flex flex-col gap-3">
                                ...
                                <form className="flex items-center justify-end gap-2" onSubmit={couponLoading ? e => e.preventDefault() : applyCoupon}>
                                    <input
                                        ...
                                        className="w-36 bg-white/8 dark:bg-gray-700 border border-gray-800 dark:border-white/20 text-gray-900 dark:text-white placeholder-white/30
                                               rounded-lg px-3 py-2 text-sm focus:outline-none focus:border-orange-500/60
                                               transition-colors"
                                    />
                                    <button
                                        type="submit"
