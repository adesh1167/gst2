    ...
    return (
        ...
        >
            ...
            <motion.div
                ...
                className="relative z-10 max-h-[100%] max-w-2xl w-full p-6 rounded-2xl bg-gradient-to-b from-[#05060a] to-[#07070a] border border-gray-800 text-gray-100 shadow-2xl overflow-scroll"
            >
                <div className="flex items-start justify-between gap-4">
                    <div>
                        <h3 className="text-2xl font-bold text-purple-400">Analysis Summary</h3>
                        <p className="text-sm text-gray-400 ">Final prediction & breakdown</p>
                    </div>
                    ...
                    <div className="col-span-1 md:col-span-2 p-4 rounded-lg bg-[rgba(255,255,255,0.02)] border border-gray-800">
                        <div className="flex items-center gap-4">
                            <div className="flex-1">
                                ...
                                <div className="text-2xl font-bold text-purple-400">{predictedWinner || "—"}</div>
                            </div>
                            <div className="text-right">
                ...
                <div className="mt-4 text-right"><button className="text-sm font-bold text-gray-900 hover:underline bg-gray-100 p-3 rounded-md" onClick={onClose}>Close</button></div>
            </motion.div>
        </motion.div>
    );
}
