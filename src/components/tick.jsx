...
const Tick = ({ checked, width = 18, height = 18, className = "", color="#000"}) => {
    return (
        checked ?
            <svg className={className} width={width} height={height} fill={"currentColor"} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
