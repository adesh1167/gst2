...
const SubscriptionCard = memo(({ price, description, title, frequency, type }) => {
    ...
    return (
        <div className="p-6 rounded-2xl bg-gray-900 border border-gray-800 hover:border-purple-500 hover:scale-1.2 transition">
            ...
            <p className="text-lg font-bold text-purple-500 orbitron-regular">
                <span className="text-2xl font-bold">{country}{formatNumber(price * (factor || 1))}</span> / {frequency}
            </p>
